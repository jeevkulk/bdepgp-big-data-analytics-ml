...
public class RainForestClassificationModel extends ClassificationPredictor {
    ...
    Dataset<Row> prepareData(Dataset<Row> rawDataset) {
        ...
        //System.out.println("Count of rows: "+ filteredDataset.count());
    ...
    Pipeline createModel(Dataset<Row> trainingDataSet) {
        ...
        //*************************************Instantiating Rain Forest Classifier***********************************//
